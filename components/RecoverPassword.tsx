...
export default function RecoverPassword() {
  ...
  const handleSubmit = async () => {
    ...
    setLoading(false);
    if (error) {
      setAlert({ msg: error.message || 'Could not send recovery email. Please try again.', ok: false });
    } else {
      setAlert({ msg: 'Recovery email sent! Check your inbox.', ok: true });
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
          <div className="w-full max-w-sm bg-sand-4 rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div className="px-6 py-5 flex flex-col gap-4">
              <div className="flex flex-col gap-1">
                ...
                <input
                  ...
                  onChange={e => { setFormEmail(e.target.value); setAlert(null); }}
            ...
            <div className="flex justify-end gap-3 px-6 pb-5">
              <button
                onClick={() => { setOpen(false); setFormEmail(''); setAlert(null); }}
